                ...
                <ul class="nav navbar-nav navbar-right" >
                    <?php
                        if(isset($_SESSION['logado']) == "sim"){
                            echo "<li id='btnModalCad' data-toggle='modal' data-target='#modalCad'><a href='#'><span class='glyphicon glyphicon-user'></span>Lucas</a></li>";
                        }else{
                            echo "<li id='btnModalCad' data-toggle='modal' data-target='#modalCad'><a href='#'><span class='glyphicon glyphicon-user'></span>Cadastrar</a></li>";
                            
                            echo "<li id='btnModalLog' data-toggle='modal' data-target='#modalLog'><a href='#'><span class='glyphicon glyphicon-user'></span> Entrar</a></li>";
                        };
                    ?>
                </ul>    
            </div>
